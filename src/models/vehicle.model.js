...
export class VehicleModel {
    static async getAll() {
        ...
        SELECT v.id, v.anio, v.color, v.precio_u, v.stock, v.tipo_combustible, v.transmision, v.kilometraje, v.nro_puertas, v.url_img, m.modelo, ma.marca, tv.tipo_vehiculo, ev.estado_vehiculo, evv.estado_vehiculo_venta
        FROM tb_vehiculo v
